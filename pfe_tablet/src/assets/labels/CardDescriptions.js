const B = "Les cartes bleues ou bâtiments civils vous octroient directement des points de victoire décomptées à la fin du jeu. Le chaînage vous sera très utile pour en obtenir un maximum.";
...
const E = "Les cartes jaunes ou cartes commerciales ont des effets particuliers qui peuvent être du gain de points de victoire, d'argent ou de ressources non vendables\n ou encore réduire le coût d'achat des ressources chez vos voisins.";
